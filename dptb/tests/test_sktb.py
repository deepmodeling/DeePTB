...
def test_nnsk_push():
    ...
    model_rs = torch.load("./dptb/tests/data/test_sktb/output/test_push_rs/checkpoint/nnsk.iter10.pth")
    model_w = torch.load("./dptb/tests/data/test_sktb/output/test_push_w/checkpoint/nnsk.iter10.pth")
    # test push limits
