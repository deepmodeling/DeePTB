...
# This list it wrong. use bond_length_list.
bond_length_list_err = torch.tensor([1.6,1.4,5.0,3.4,3.0,3.2,3.4,3.1,2.7,3.2,5.9,5.0,5.9,4.4,4.0,3.9,
...
bond_length_list_bohr = torch.tensor([1.6, 1.4, 5.0, 3.4, 3.0, 3.2, 3.4, 3.1, 2.7, 3.2, 5.9, 5.0, 5.9, 4.4, 4.0, 3.9, 
                                ...
                                -100, -100, -100, -100, -100, -100, -100, 5.9, 5.2, 4.8, 4.2, 4.2, 4.0, 3.9, 3.8, 4.8, 
                                6.7, 7.3, 5.7, 5.8, 5.5, -100, -100, -100, 7.0, -100, 6.2, -100, -100, -100, -100, -100, 
...
bond_length_full_dict = {
 ...
 'Na': 5.9,                                                                                                               'Mg': 5.0, 'Al': 5.9, 'Si': 4.4,  'P': 4.0,  'S': 3.9, 'Cl': 3.8, 'Ar': 4.5,
 'K': 6.5,   'Ca': 4.9, 'Sc': 5.1, 'Ti': 4.2, 'V': 4.3, 'Cr': 4.7, 'Mn': 3.6, 'Fe': 3.7, 'Co': 3.3, 'Ni': 3.7, 'Cu': 5.2, 'Zn': 4.6, 'Ga': 5.9, 'Ge': 4.5, 'As': 4.4, 'Se': 4.5, 'Br': 4.3, 'Kr': 4.8,
 'Rb': 9.1,  'Sr': 6.9, 'Y': 5.7, 'Zr': 5.2, 'Nb': 5.2, 'Mo': 4.3, 'Tc': 4.1, 'Ru': 4.1, 'Rh': 4.0, 'Pd': 4.4, 'Ag': 6.5, 'Cd': 5.4, 'In': 4.8, 'Sn': 4.7, 'Sb': 5.2, 'Te': 5.2,  'I': 6.2, 'Xe': 5.2,
