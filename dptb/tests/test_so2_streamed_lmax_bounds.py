...
def test_so2_streamed_ref_handles_out_lmax_gt_in_lmax(wigner_apply_mode, rotate_in, rotate_out):
    ...
    streamed = SO2_Linear(**kwargs, so2_fusion_mode="streamed_m_major_ref").to(dtype=dtype)
