...
def train_options():
    ...
    doc_use_tensorboard = "Set true to use tensorboard. It will record iteration error once every `25` iterations, epoch error once per epoch. " \
                          "train_loss_iter is iteration loss, train_loss_last is the error of the last iteration in an epoch, train_loss_mean is the mean error of all iterations in an epoch." \
