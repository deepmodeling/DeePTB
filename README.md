...
```
cd existing_repo
git remote add origin https://gitlab.com/deeptransport/deepnegf.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/deeptransport/deepnegf/-/settings/integrations)
