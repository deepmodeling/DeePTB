...
def test_tbplas_get_cell(root_directory):
    ...
    assert cell.get_orbital(0).energy == -5.0404769961265075
    assert cell.get_orbital(1).energy == 3.4503467496010316
    assert cell.get_orbital(-1).energy == 11.223119538602496

    # check cell hopping value
    assert cell.get_hopping(orb_i=0, orb_j=9, rn=(0,0,0)) == 1.8239758014678955
    assert cell.get_hopping(orb_i=0, orb_j=10, rn=(0,0,0)) == 1.259192943572998
