...
# ==========================================
# Modified Components with Layer Norm Restored
# ==========================================
...
class UpdateNodeGlobal(torch.nn.Module):
    ...
    def forward(self, latents, node_features, edge_features, atom_type, node_onehot, edge_index, edge_vector,
        ...
        message, _ = self.tp(
            torch.cat([norm_node_features[edge_center[active_edges]], norm_edge_features], dim=-1),
