...
class ComformerConv_edge(nn.Module):
    ...
    def forward(self, edge: Union[Tensor, PairTensor], edge_nei_len: OptTensor = None, edge_nei_angle: OptTensor = None, mask=None):
        ...
        print('####################')
        print('Angle info:')
        print(edge_xy[mask][0])
        print(edge_xy[mask][1])
        print('####################')
        print('Raw Angle info:')
        print(edge_nei_angle[mask][0])
        print(edge_nei_angle[mask][1])

        print('####################')
        print('Edge length info:')
        print(query_x[mask][0])
        print(query_x[mask][1])
        print('####################')
        print('Lattice vector length info:')
        print(key_x[mask][0])
        print(key_x[mask][1])
        print('####################')
        print('Lattice vector length info:')
        print(edge_nei_len[mask][0])
        print(edge_nei_len[mask][1])
        print('####################')
        ...
        print('Attention score info:')
        print(alpha[mask][0])
        print(alpha[mask][1])
        print('####################')

        print('Value y info:')
        print(value_y[mask][0])
        print(value_y[mask][1])
        print('####################')

        print('Value x info:')
        print(value_x[mask][0])
        print(value_x[mask][1])
        print('####################')
        ...
        cat_info = torch.cat((value_x, value_y, edge_xy), dim=-1)

        print('Cat info:')
        print(cat_info[mask][0])
        print(cat_info[mask][1])
        print('####################')
        ...
        print('####################')
        print('Residual update info before sum:')
        print(out[mask][0])
        print(out[mask][1])
        print('####################')
